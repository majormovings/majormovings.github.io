(() => {
    ...
    if (window.mobileCheck()) {
        document.querySelector('#service-toggle a').addEventListener('click', () => {
            document.querySelector('#service-toggle a').classList.toggle('show');
            document.querySelector('#service-toggle .dropdown-menu').classList.toggle('show');
        })
    } else {
